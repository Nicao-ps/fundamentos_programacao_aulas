print('\n'+(89*'='))
print((18*' ')+'Welcome to the freight cost calculator! (Version 2.0)'+(18*' '))
print((89*'=')+'\n')
...
if distance > 10.0:
    ...
    freight_cost = 5.00 + (2.00*(distance - 5.0)) + 5.00
    print('\n'+f'The freight cost for {distance:.3f} km is R$ {freight_cost:.2f}.')
elif distance > 0.0:
    freight_cost = 5.00 + (1.00 * distance)
    print('\n'+f'The freight cost for {distance:.3f} km is R$ {freight_cost:.2f}.')
else:
